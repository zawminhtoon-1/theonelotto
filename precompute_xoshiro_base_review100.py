...
last 100 real draws, this stops at the Base-pool-construction stage
...
Output: xoshiro_base_review100_meta.json
Run: python precompute_xoshiro_base_review100.py
"""
...
META_OUT = BASE + r"\xoshiro_base_review100_meta.json"
