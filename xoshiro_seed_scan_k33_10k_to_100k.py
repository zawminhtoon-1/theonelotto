"""
xoshiro_seed_scan_k33_10k_to_100k.py
---------------------------------------
Extension of xoshiro_seed_scan_k33_1127.py: seeds 10,001-100,000 (90,000
...
ranking. Adds to (not replaces) the existing seeds 0-10,000 already in
seed_hit_xoshiro_k33 -- combined, this covers the full 0-100,000 range.

Draw records pulled from the production Neon Postgres DB (same as
xoshiro_seed_scan_k33_1127.py), verified for exactly 1127 consecutive
rows before scanning.

Run: python xoshiro_seed_scan_k33_10k_to_100k.py
"""
...
OUT_JSON = BASE + r"\xoshiro_seed_scan_k33_10k_to_100k.json"

K_PICKS = 33
DRAW_START, DRAW_END = 1001, 2127
N_DRAWS = DRAW_END - DRAW_START + 1  # 1127
LOTO6_MAX = 43
SEED_LO, SEED_HI = 10_001, 100_000   # inclusive -- extends the existing 0-10,000 range
N_WORKERS = 7
CHUNK_SIZE = 200
...
def main():
    ...
    for test_seed, test_draw in [(10001, 1001), (2200, 2127), (99999, 1500), (55555, 2000), (100000, 2127)]:
