"""
load_xoshiro_seed_scan_loto7_k25_stage_to_db.py
----------------------------------------------------
Loads one stage's JSON output (from xoshiro_seed_scan_loto7_k25_stage.py)
into loto7_local.db's seed_hit_xoshiro_k25 table. Creates the table on
first call (if absent); subsequent calls INSERT-append, since each
stage's seed range is disjoint (seed is the PRIMARY KEY).

Usage: python load_xoshiro_seed_scan_loto7_k25_stage_to_db.py <stage_num>
"""
...
JSON_IN = BASE + rf"\xoshiro_seed_scan_loto7_k25_stage{stage_num}.json"
