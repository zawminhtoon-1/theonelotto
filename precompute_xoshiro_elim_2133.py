"""
precompute_xoshiro_elim_2133.py
-----------------------------------
Precomputes everything the "Xoshiro K=38 x Modular Cycle K=33 + 16-Method
Elimination" page needs for draw #2133 -- the true next-upcoming Loto6
draw (#2132 is now the latest real/confirmed draw, having landed since
xoshiro_elim_2132.html was built). Standard walk-forward build, same
...
META_OUT = BASE + r"\xoshiro_elim_2133_meta.json"
COMBOS_OUT = BASE + r"\public\xoshiro_elim_2133_combos.json"
