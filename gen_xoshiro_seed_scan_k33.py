...
<title>Xoshiro Seed Scan K=33 (0–10,000) — Loto 6</title>
  ...
  <div class="nav-groups">
    ...
    <div class="nav-group">
      ...
      <div class="nav-dropdown"><div class="nav-dropdown-inner">
        ...
        <a href="/xoshiro_seed_scan_k33.html" class="active">🎯 Xoshiro K=33 Scan (0–10k)</a>
...
<div class="wrap">
  <h1>🎯 Xoshiro Seed Scan — K=33 (0–10,000)</h1>
