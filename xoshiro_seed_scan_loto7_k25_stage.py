"""
xoshiro_seed_scan_loto7_k25_stage.py
----------------------------------------
Parameterized stage runner extending the Loto7 K=25 xoshiro scan from
0-10,000 to the full -1,000,000 to 1,000,000 range (2,000,001 seeds
total), split into 4 roughly equal stages of ~500,000 seeds each --
same staged-negative-seed pattern already verified on the Loto6 K=35
scan (xoshiro_seed_scan_k35_stage.py). Same xoshiro256** algorithm/
...
wrap -- no special-casing needed), same draw window #1-500, same
hit7b/hit7/hit6/hit5/hit4 metrics as xoshiro_seed_scan_loto7_k25_10k.py.
Self-checks (including negative-seed cases) before scaling, per stage.

Usage: python xoshiro_seed_scan_loto7_k25_stage.py <stage_num> <seed_lo> <seed_hi>
Example: python xoshiro_seed_scan_loto7_k25_stage.py 1 -1000000 -500001
"""
...
def main():
    ...
    OUT_JSON = BASE + rf"\xoshiro_seed_scan_loto7_k25_stage{stage_num}.json"
