        ...
        <header className="border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
          <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <nav className="flex gap-6 text-sm text-gray-600 dark:text-gray-400">
              ...
              <a href="/predictions" className="hover:text-gray-900 dark:hover:text-white transition-colors">Predictions</a><a href="/history" className="hover:text-gray-900 dark:hover:text-white transition-colors">
                History
              </a>
            </nav>
          </div>
