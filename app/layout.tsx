...
const NAV_GROUPS: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/random_seed_backtest.html", icon: "🎲", label: "Random Seed (±1,236,700)" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/xoshiro_elim_2130.html", icon: "✂️", label: "Draw #2130 Elimination" },
      { href: "/xoshiro_elim_2131.html", icon: "✂️", label: "Draw #2131 Elimination" },
      { href: "/xoshiro_elim_2132.html", icon: "✂️", label: "Draw #2132 Elimination" },
