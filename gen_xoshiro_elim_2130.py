"""
gen_xoshiro_elim_2130.py
----------------------------
Generates the "Xoshiro K=38 x Modular Cycle K=33 + 16-Method Elimination"
page for draw #2130 (next upcoming Loto6 draw, #2129 being the latest
real/confirmed draw). Reads xoshiro_elim_2130_meta.json (small: pool
picks, method picks, counts) produced by precompute_xoshiro_elim_2130.py.
The large remaining-combo list lives separately at
public/xoshiro_elim_2130_combos.json (already written by the precompute
...
and xoshiro K=38 seed #692,809's pick, both for #2130 -- same 28-number
...
Output: public/xoshiro_elim_2130.html
Run: python gen_xoshiro_elim_2130.py
"""
import json

BASE = r"C:\Users\Zaw Min Htoon\source\repos\theonelotto"
META_PATH = BASE + r"\xoshiro_elim_2130_meta.json"
HTML_OUT = BASE + r"\public\xoshiro_elim_2130.html"
...
<div class="wrap">
  ...
  <div class="note">
    ...
    <strong>xoshiro256** K={xo['k']} seed #{xo['seed']:,}'s pick</strong> &mdash; both for draw #{TARGET_SERIAL}. This is the same
    {base['k']}-number intersection shown on <a href="/xoshiro_k38_x_modularcycle_k33_intersection.html" style="color:#a78bfa">the
    Modular Cycle (K=33) × K=38 intersection page</a>'s "next upcoming draw" reference. It defines the working universe: all
  ...
  <div class="section">
    ...
    <p class="desc">Modular Cycle: walk-forward pick trained on all real draws through #{TARGET_SERIAL-1}, native K=28 normalized to K={mc['k']}
