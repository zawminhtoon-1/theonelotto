"""
extend_random_seed_window_2132.py
--------------------------------------
...
#1001-2131 (1131 draws) up to #1001-2132 (1132 draws) WITHOUT a full
rescan -- same incremental-delta pattern as extend_random_seed_window_2131.py.

For every seed already in the table (2,473,401 rows, seeds -1,236,700
to 1,236,700), computes K=17 picks only for the 1 new draw (#2132)
via the same random.Random(seed*10_000_000+draw_serial).sample()
...
Run: python extend_random_seed_window_2132.py
"""
...
K_PICKS = 17
LOTO6_MAX = 43
OLD_WINDOW = (1001, 2131)
NEW_DRAWS = [2132]
NEW_WINDOW = (1001, 2132)
N_WORKERS = 7
CHUNK_SIZE = 2000
