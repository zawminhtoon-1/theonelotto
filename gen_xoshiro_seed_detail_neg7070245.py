...
<div class="wrap">
  ...
  <div class="section">
    ...
    <p class="desc">Rendered live in your browser from the embedded draw records — the amber-tinted rows are the out-of-sample #{IN_SAMPLE_END+1}\u2013{DRAW_END} draws.</p>
    <details id="ownBreakdownDetails">
      <summary>Show all {COMBINED_N} draws</summary>
      <div class="tbl-wrap">
        <table class="draw-tbl">
          <thead><tr><th>Draw</th><th>Date</th><th>Actual (6) + bonus</th><th>Picks (38) · generation order</th><th style="text-align:center">Hits</th></tr></thead>
...
document.getElementById('ownBreakdownTbody').innerHTML = oosResult.html + inResult.html;
